...
QT_MOC_LITERAL(1, 11, 6), // "__exit"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 6) // "__show"

    },
    "SystemTray\0__exit\0\0__show"
};
...
void SystemTray::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->__exit(); break;
        case 1: _t->__show(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemTray::__exit)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SystemTray::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SystemTray::__show)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SystemTray::__exit()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SystemTray::__show()
{
